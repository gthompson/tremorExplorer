...
SDS_TOP=os.path.join(PRODUCTS_TOP,'DATA','SDS')
...
fdsnURL = "GEONET"
subnet = 'Whakaari'
SGRAM_TOP = os.path.join(PRODUCTS_TOP, 'IceWeb')
...
wrappers.SDS_to_picklefile_wrapper(startt, endt, SDS_TOP, freqmin=0.5, freqmax=20.0, \
        zerophase=False, corners=2, sampling_interval=60.0, sourcelat=centerlat, \
            sourcelon=centerlon, inv=inv, trace_ids=trace_ids, overwrite=False, verbose=True, timeWindowMinutes=10,  timeWindowOverlapMinutes=5, PICKLEDIR=PICKLEDIR, subnet=subnet)
...
<FDSNStationXML xmlns="http://www.fdsn.org/xml/station/1" schemaVersion="1.1">
  ...
  <Created>2023-10-23T20:32:53.435868Z</Created>
  <Network code="FL">
    <Station code="BCHH" startDate="2017-08-01T00:00:00.000000Z" endDate="2025-12-31T00:00:00.000000Z">
      <Latitude unit="DEGREES">0.0</Latitude>
      <Longitude unit="DEGREES">0.0</Longitude>
      <Elevation unit="METERS">0.0</Elevation>
      <Site>
        <Name>Beach House Sonic</Name>
      </Site>
      <CreationDate>2017-08-01T00:00:00.000000Z</CreationDate>
      <Channel code="HDF" startDate="2017-08-01T00:00:00.000000Z" endDate="2025-12-31T00:00:00.000000Z" locationCode="">
        <Latitude unit="DEGREES">0.0</Latitude>
        <Longitude unit="DEGREES">0.0</Longitude>
        <Elevation unit="METERS">0.0</Elevation>
        ...
        <Response>
          ...
          <Stage number="1">
            <PolesZeros>
              ...
              <NormalizationFactor>0.2917</NormalizationFactor>
              ...
              <Zero number="3">
                <Real minusError="-4080.0" plusError="-4080.0">-4080.0</Real>
                <Imaginary minusError="0.0" plusError="0.0">0.0</Imaginary>
              </Zero>
              <Pole number="0">
                <Real minusError="-0.157" plusError="-0.157">-0.157</Real>
                <Imaginary minusError="0.0" plusError="0.0">0.0</Imaginary>
              </Pole>
              <Pole number="1">
                <Real minusError="-0.157" plusError="-0.157">-0.157</Real>
                <Imaginary minusError="-3e-06" plusError="-3e-06">-3e-06</Imaginary>
              </Pole>
              <Pole number="2">
                <Real minusError="-0.157" plusError="-0.157">-0.157</Real>
                <Imaginary minusError="3e-06" plusError="3e-06">3e-06</Imaginary>
              ...
              <Pole number="3">
                <Real minusError="-1190.0" plusError="-1190.0">-1190.0</Real>
                <Imaginary minusError="0.0" plusError="0.0">0.0</Imaginary>
              </Pole>
            </PolesZeros>
            <StageGain>

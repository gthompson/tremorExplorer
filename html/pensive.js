...
var pathFormatter = new SimpleDateFormat("yyyy/DDD");

/** format used to form image suffix. Passed in from config file */
var fileFormatter = new SimpleDateFormat("_yyyyMMdd-HHmm");
...
function init() {
	...
	// fire subnet change trigger to get things rolling
	  ...
	  if (param == null) {
		  $("#network").val("AVO").prop('selected', true);
	  }
